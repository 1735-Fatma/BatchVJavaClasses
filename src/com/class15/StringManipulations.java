...
public class StringManipulations {
	...
	public static void main(String[] args) {
		...
		//verify if there if in the String is Empty
		String myString="";//empty value
		boolean isEmpty=myString.isEmpty();
		System.out.println(isEmpty);
		
		String myString1=null;//no value at all it is equal to it is not empty but it gives error 
		//String myString1;
		System.out.println(myString1.isEmpty());
		
		//how to verify existence of characters in the String 
		String a="Good evening students";
		boolean exist=a.contains("student");//true
